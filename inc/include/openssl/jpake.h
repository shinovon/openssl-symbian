 ...
 */
SSL2_IMPORT void JPAKE_STEP1_init(JPAKE_STEP1 *s1);
SSL2_IMPORT int JPAKE_STEP1_generate(JPAKE_STEP1 *send, JPAKE_CTX *ctx);
SSL2_IMPORT int JPAKE_STEP1_process(JPAKE_CTX *ctx, const JPAKE_STEP1 *received);
SSL2_IMPORT void JPAKE_STEP1_release(JPAKE_STEP1 *s1);

/*
 * Note that JPAKE_STEP2 can be used multiple times before release
 * without another init.
 */
SSL2_IMPORT void JPAKE_STEP2_init(JPAKE_STEP2 *s2);
SSL2_IMPORT int JPAKE_STEP2_generate(JPAKE_STEP2 *send, JPAKE_CTX *ctx);
SSL2_IMPORT int JPAKE_STEP2_process(JPAKE_CTX *ctx, const JPAKE_STEP2 *received);
SSL2_IMPORT void JPAKE_STEP2_release(JPAKE_STEP2 *s2);
 ...
 */
SSL2_IMPORT void JPAKE_STEP3A_init(JPAKE_STEP3A *s3a);
SSL2_IMPORT int JPAKE_STEP3A_generate(JPAKE_STEP3A *send, JPAKE_CTX *ctx);
SSL2_IMPORT int JPAKE_STEP3A_process(JPAKE_CTX *ctx, const JPAKE_STEP3A *received);
SSL2_IMPORT void JPAKE_STEP3A_release(JPAKE_STEP3A *s3a);

SSL2_IMPORT void JPAKE_STEP3B_init(JPAKE_STEP3B *s3b);
SSL2_IMPORT int JPAKE_STEP3B_generate(JPAKE_STEP3B *send, JPAKE_CTX *ctx);
SSL2_IMPORT int JPAKE_STEP3B_process(JPAKE_CTX *ctx, const JPAKE_STEP3B *received);
SSL2_IMPORT void JPAKE_STEP3B_release(JPAKE_STEP3B *s3b);
